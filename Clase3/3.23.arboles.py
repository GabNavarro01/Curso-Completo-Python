...
parque_GENERAL_PAZ = leer_parque('../Data/arbolado-en-espacios-verdes.csv', nombre_general_paz)
parque_LOS_ANDES = leer_parque('../Data/arbolado-en-espacios-verdes.csv', nombre_los_andes)
parque_CENTENARIO = leer_parque('../Data/arbolado-en-espacios-verdes.csv', nombre_centenario)
# pprint(len(arboles))
