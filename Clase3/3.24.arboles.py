...
# print(f'El especimen mas inclinado del parque {nombre_general_paz} es {especimen_mas_inclinado(parque_GENERAL_PAZ)}')
# print(f'El especimen mas inclinado del parque {nombre_los_andes} es {especimen_mas_inclinado(parque_LOS_ANDES)}')
# print(f'El especimen mas inclinado del parque {nombre_centenario} es {especimen_mas_inclinado(parque_CENTENARIO)}')

print(f'El mayor promedio de inclinaciones del parque {nombre_general_paz} es {especie_promedio_mas_inclinada(parque_GENERAL_PAZ)}')
print(f'El mayor promedio de inclinaciones del parque {nombre_los_andes} es {especie_promedio_mas_inclinada(parque_LOS_ANDES)}')
print(f'El mayor promedio de inclinaciones del parque {nombre_centenario} es {especie_promedio_mas_inclinada(parque_CENTENARIO)}')
