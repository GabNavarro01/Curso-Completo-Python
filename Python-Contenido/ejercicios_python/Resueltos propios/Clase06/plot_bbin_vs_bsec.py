# -*- coding: utf-8 -*-
"""
Created on Sat Jan 22 17:23:56 2022
...
comps_promedio1=np.zeros(256)

for i, n in enumerate(largos):
    lista=generar_lista(n,m)
    comps_promedio[i]=experimento_binario_promedio(lista,m,k)
    comps_promedio1[i]=experimento_secuencial_promedio(lista,m,k)
    
plt.plot(largos,comps_promedio1,label = 'Búsqueda secuencial', color='red')
